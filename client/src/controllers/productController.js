...
const addProduct = async (name, description, images,videos, basePrice, salePrice,
    category, subCategory, sizes, bestSeller,freeShipping, colors) => {
    ...
    const info = JSON.stringify({
        name, description, images,videos, basePrice, salePrice,
        category, subCategory, sizes, bestSeller, colors,freeShipping
    })
...
const updateProduct = async (name, description, images,videos, basePrice, salePrice,
    category, subCategory, sizes, bestSeller, freeShipping, colors,id) => {
